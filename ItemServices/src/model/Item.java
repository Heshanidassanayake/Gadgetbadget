...
//view list of Items	
public List<ItemService> viewItem() {
...
private List<ItemService> readItems(int id) {
	// TODO Auto-generated method stub
	return null;
}
//View the Items by ID 
	public ItemService viewItemById(int id) {
	List<ItemService> list =readItems(id);
		if(!list.isEmpty()) {
			return	list.get(0);
		}
		return null;
